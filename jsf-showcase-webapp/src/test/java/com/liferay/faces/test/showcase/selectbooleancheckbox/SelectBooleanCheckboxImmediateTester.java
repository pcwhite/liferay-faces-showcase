 ...
 * @author  Philip White
 */
public class SelectBooleanCheckboxImmediateTester extends SelectTester {
	...
	public void runSelectBooleanCheckboxImmediateTest() throws Exception {
		...
		// Test that the unchecked second checkbox submits successfully.
		text = "false";
		...
		// Test that the checked second checkbox submits successfully.
		browser.click(checkbox2Xpath);
		text = "true";
		browser.clickAndWaitForAjaxRerender(submitButton2Xpath);
		SeleniumAssert.assertElementTextVisible(browser, modelValue2Xpath, text);
